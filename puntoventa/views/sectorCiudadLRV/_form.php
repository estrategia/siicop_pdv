...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <input type="hidden" name="SectorCiudadLRV_CodCiudad_Ant" value="<?php echo $model->CodCiudad ?>" />
        <input type="hidden" name="SectorCiudadLRV_IDSectorLRV_Ant" value="<?php echo $model->IDSectorLRV ?>" />
        <?php endif; ?>
