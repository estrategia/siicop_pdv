    ...
    <div id="dataDiv" class="container-fluid" style='width:100%;'>
        <script type="text/javascript" charset="utf-8">           
            ...
            columns:[                 
                ...
                { id:"NombrePuntoDeVenta", header:["Punto de venta", {content:"textFilter"}], template:"#IDComercial# - #NombrePuntoDeVenta#",fillspace:true,sort:"string",css:"zebra",
        ...
        onClick:{            
            "agregarPDV":function(e, id, trg){  
                ...
                {                    
                    ...
                    var url = $("#base").val() + "/puntoventa/sectoresLRV/agregar";
